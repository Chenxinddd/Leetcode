public class RegualExpressionMatching{
    ...
    public static boolean dfs(String s, String p, int i, int j, int m, int n, Boolean[][] M){
       if(j == n){
         return i == m;
       }
       if(M[i][j] != null){
       ...
       if( j < n -1 && p.charAt(j+1) == '*'){
          ...
          i < m && match(s.charAt(i), c2) && dfs(s, p, i+1, j+1, m, n, M);
       }
